(() => {
    ...
    const __require = /* @__PURE__ */ ((x) => typeof require !== 'undefined'
        ? require
    ...
    const require_basicLightbox_min = __commonJS({
            ...
            !(function(e) {
                ...
                return (function e(n, t, o) {
                    function r(c2, u) {
                        if (!t[c2]) {
                            if (!n[c2]) {
                                const s = typeof __require === 'function' && __require;
                                if (!u && s) return s(c2, true);
                                if (i) return i(c2, true);
                                const a = new Error("Cannot find module '" + c2 + "'");
                                throw a.code = 'MODULE_NOT_FOUND', a;
                            }
                            const l = t[c2] = { exports: {} };
                    ...
                    for (var i = typeof __require === 'function' && __require, c = 0; c < o.length; c++) r(o[c]);
                    return r;
                }({
                    1: [function(e, n, t) {
                        'use strict';
                        ...
                        const o = function(e2) {
                            const n2 = arguments.length > 1 && void 0 !== arguments[1] && arguments[1]; const t2 = document.createElement('div');
                            return t2.innerHTML = e2.trim(), n2 === true ? t2.children : t2.firstChild;
                        }; const r = function(e2, n2) {
                            const t2 = e2.children;
                            return t2.length === 1 && t2[0].tagName === n2;
                        }; const i = function(e2) {
                            return (e2 = e2 || document.querySelector('.basicLightbox')) != null && e2.ownerDocument.body.contains(e2) === true;
                        };
                        t.visible = i;
                        t.create = function(e2, n2) {
                            const t2 = (function(e3, n3) {
                                const t3 = o('\n		<div class="basicLightbox '.concat(n3.className, '">\n			<div class="basicLightbox__placeholder" role="dialog"></div>\n		</div>\n	')); const i2 = t3.querySelector('.basicLightbox__placeholder');
                                e3.forEach(function(e4) {
                                    return i2.appendChild(e4);
                                });
                                const c2 = r(i2, 'IMG'); const u2 = r(i2, 'VIDEO'); const s = r(i2, 'IFRAME');
                                return c2 === true && t3.classList.add('basicLightbox--img'), u2 === true && t3.classList.add('basicLightbox--video'), s === true && t3.classList.add('basicLightbox--iframe'), t3;
                            }(e2 = (function(e3) {
                                const n3 = typeof e3 === 'string'; const t3 = e3 instanceof HTMLElement == 1;
                                if (n3 === false && t3 === false) throw new Error('Content must be a DOM element/node or string');
                                return n3 === true ? Array.from(o(e3, true)) : e3.tagName === 'TEMPLATE' ? [e3.content.cloneNode(true)] : Array.from(e3.children);
                            }(e2)), n2 = (function() {
                                let e3 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                                if ((e3 = Object.assign({}, e3)).closable == null && (e3.closable = true), e3.className == null && (e3.className = ''), e3.onShow == null && (e3.onShow = function() {
                                }), e3.onClose == null && (e3.onClose = function() {
                                }), typeof e3.closable !== 'boolean') throw new Error('Property `closable` must be a boolean');
                                if (typeof e3.className !== 'string') throw new Error('Property `className` must be a string');
                                if (typeof e3.onShow !== 'function') throw new Error('Property `onShow` must be a function');
                                if (typeof e3.onClose !== 'function') throw new Error('Property `onClose` must be a function');
                                return e3;
                            }(n2)))); const c = function(e3) {
                                return n2.onClose(u) !== false && (function(e4, n3) {
                                    return e4.classList.remove('basicLightbox--visible'), setTimeout(function() {
                                        return i(e4) === false || e4.parentElement.removeChild(e4), n3();
                                    }, 410), true;
                                }(t2, function() {
                                    if (typeof e3 === 'function') return e3(u);
                                }));
                            };
                            n2.closable === true && t2.addEventListener('click', function(e3) {
                                e3.target === t2 && c();
                            });
                            var u = {
                                element: function() {
                                ...
                                show: function(e3) {
                                    return n2.onShow(u) !== false && (function(e4, n3) {
    ...
    // docs/js/main.js
    const basicLightbox = __toESM(require_basicLightbox_min());
